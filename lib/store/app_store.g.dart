...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$empCodeAtom = Atom(name: '_AppStore.empCode', context: context);

  @override
  String get empCode {
    _$empCodeAtom.reportRead();
    return super.empCode;
  }

  @override
  set empCode(String value) {
    _$empCodeAtom.reportWrite(value, super.empCode, () {
      super.empCode = value;
    });
  }

  late final _$empPermissionAtom =
      Atom(name: '_AppStore.empPermission', context: context);

  @override
  String get empPermission {
    _$empPermissionAtom.reportRead();
    return super.empPermission;
  }

  @override
  set empPermission(String value) {
    _$empPermissionAtom.reportWrite(value, super.empPermission, () {
      super.empPermission = value;
    });
  }
  ...
  late final _$setEmpCodeAsyncAction =
      AsyncAction('_AppStore.setEmpCode', context: context);

  @override
  Future<void> setEmpCode(String val) {
    return _$setEmpCodeAsyncAction.run(() => super.setEmpCode(val));
  }

  late final _$setEmpPermissionAsyncAction =
      AsyncAction('_AppStore.setEmpPermission', context: context);

  @override
  Future<void> setEmpPermission(String val) {
    return _$setEmpPermissionAsyncAction.run(() => super.setEmpPermission(val));
  }
  ...
  @override
  Future<void> setCartCount(int count, {bool isInitializing = false}) {
    return _$setCartCountAsyncAction
        .run(() => super.setCartCount(count, isInitializing: isInitializing));
  }
