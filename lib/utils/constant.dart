...
var appPackageName = isAndroid ? 'com.jito.jivanand' : 'com.jito.jivanand';
...
const LIVESTREAM_OFFER_PRODUCT_DASHBOARD = "streamUpdateOfferProduct";
...
const LIVESTREAM_PRODUCT_SCREEN = "LIVESTREAM_PRODUCT_SCREEN";
const LIVESTREAM_PATIENT_SCREEN = "LIVESTREAM_PATIENT_SCREEN";
const LIVESTREAM_VAID_SCREEN = "LIVESTREAM_VAID_SCREEN";
const LIVESTREAM_CATEGORY_SCREEN = "LIVESTREAM_CATEGORY_SCREEN";
const LIVESTREAM_COLOR_SCREEN = "LIVESTREAM_COLOR_SCREEN";
const LIVESTREAM_OFFER_FROM_LIST_SCREEN = "LIVESTREAM_OFFER_FROM_LIST_SCREEN";

//endregion

//region default USER login
const DEFAULT_EMAIL = 'demo@veer.com';
...
const EMP_PERMISSION = 'EMP_PERMISSION';
...
const DATE_FORMAT_FILE = 'yyyy_MM_dd_HH_mm_ss';
const DATE_FORMAT_FILE_PDF = 'yyyyMMdd_HHmmss';
const DATE_FORMAT_1 = 'dd-MMM-yyyy hh:mm a';

const DATE_FORMAT_DAY_MONTH_YEAR_TIME = 'dd-MM-yyyy hh:mm a';
const DATE_FORMAT_2 = 'd MMM, yyyy';
const DATE_FORMAT_3 = 'dd-MMM-yyyy';
const DATE_FORMAT_32 = 'dd-MM-yyyy';
